              ...
              {isMenuOpen && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    onClick={onLogout}
                    className="w-full text-left px-4 py-6 text-sm text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-all duration-200 rounded border border-transparent hover:border-red-500/30"
                  >
                    <div className="flex items-center gap-2">
                      <svg
                        className="w-4 h-4"
